...
namespace Minima.CatalogCore.Business.Services.Collections;
...
public interface IProductCollectionService
{
    ...
    Task<IPagedList<ProductCollection>> GetProductCollectionsByCollectionId(string collectionId, string storeId,
