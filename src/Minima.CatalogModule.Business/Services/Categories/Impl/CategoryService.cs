...
using Minima.Infrastructure.Extensions;
using Minima.Platform.Data;
using Minima.Services.Extensions;
using Minima.Services.Interfaces.Common.Security;
using Minima.Shared.Extensions;

namespace Minima.CatalogCore.Business.Services.Categories.Impl;
...
public partial class CategoryService : ICategoryService
{
    ...
    public virtual async Task<IList<Category>> GetMenuCategories()
    {
        ...
        if ((!CommonHelper.IgnoreAcl || !CommonHelper.IgnoreStoreLimitations))
        {
