using Minima.Domain.Configuration;
...
public class CatalogSettings : ISettings
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether to display collection part number of a product
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the value indicating how many collections to display in collections block
    /// </summary>
