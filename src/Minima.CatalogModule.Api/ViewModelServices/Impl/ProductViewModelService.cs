...
// using Minima.CatalogModule.Api.Domain;
// using Minima.CatalogModule.Api.Extensions;
// using Minima.CatalogModule.Api.Interfaces.Catalog.Categories;
// using Minima.CatalogModule.Api.Interfaces.Catalog.Collections;
// using Minima.CatalogModule.Api.Interfaces.Catalog.Products;
// using Minima.CatalogModule.Api.Models.Catalog;
// using Minima.Platform.Domain.Localization;
// using Minima.Platform.Domain.Media;
// using Minima.Platform.Services.Extensions;
// using Minima.Platform.Services.Interfaces.Common.Directory;
// using Minima.Platform.Services.Interfaces.Common.Localization;
// using Minima.Platform.Services.Interfaces.Common.Logging;
// using Minima.Platform.Services.Interfaces.Customers;
// using Minima.Platform.Services.Interfaces.Storage;
//
// namespace Minima.CatalogModule.Api.ViewModelServices.Impl;
//
...
//     }
//
//     public virtual async Task PrepareAddProductAttributeCombinationModel(ProductModel.ProductAttributeCombinationModel model, Product product)
//     {
//         if (model == null)
...
//                 var attributeModel = new ProductModel.ProductAttributeCombinationModel.ProductAttributeModel {
//                     Id = attribute.Id,
...
//                     {
//                         var attributeValueModel = new ProductModel.ProductAttributeCombinationModel.ProductAttributeValueModel {
...
//     }
//
//     public virtual async Task<ProductModel.ProductAttributeCombinationModel> PrepareProductAttributeCombinationModel(Product product, string combinationId)
//     {
//         var model = new ProductModel.ProductAttributeCombinationModel();
//         var wim = new List<ProductModel.ProductAttributeCombinationModel.WarehouseInventoryModel>();
//         foreach (var warehouse in await _warehouseService.GetAllWarehouses())
//         {
//             var pwiModel = new ProductModel.ProductAttributeCombinationModel.WarehouseInventoryModel {
//                 WarehouseId = warehouse.Id,
//                 WarehouseName = warehouse.Name
//             };
//             wim.Add(pwiModel);
...
//         return model;
//     }
//     public virtual async Task<IList<string>> InsertOrUpdateProductAttributeCombinationPopup(Product product, ProductModel.ProductAttributeCombinationModel model, Dictionary<string, string> form)
//     {
//         var customAttributes = new List<CustomAttribute>();
