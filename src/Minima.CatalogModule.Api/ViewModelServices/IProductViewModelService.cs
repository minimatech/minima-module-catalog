...
//
// namespace Minima.CatalogModule.Api.ViewModelServices;
//
...
//     Task PrepareAddProductAttributeCombinationModel(ProductModel.ProductAttributeCombinationModel model, Product product);
...
//     Task<ProductModel.ProductAttributeCombinationModel> PrepareProductAttributeCombinationModel(Product product, string combinationId);
//     //tier prices for combination
//     Task<IList<string>> InsertOrUpdateProductAttributeCombinationPopup(Product product, ProductModel.ProductAttributeCombinationModel model, Dictionary<string, string> form);
